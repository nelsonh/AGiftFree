...
@implementation NewGiftTableHintContrller
...
@synthesize giftNotLockIconImageView;
@synthesize giftNotLockIconTextView;
...
- (void)viewDidUnload {
	...
	self.giftNotLockIconImageView=nil;
	self.giftNotLockIconTextView=nil;
...
-(IBAction)tableHintButtonPress
{
	...
	[giftNotLockIconImageView setHidden:NO];
	[giftNotLockIconTextView setHidden:NO];
...
-(void)reset
{
	...
	[giftNotLockIconImageView setHidden:YES];
	[giftNotLockIconTextView setHidden:YES];
...
- (void)dealloc {
	...
	[giftNotLockIconImageView release];
	[giftNotLockIconTextView release];
